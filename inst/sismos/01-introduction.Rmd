...
```{r}
indice.ts <- ts(sismo_3$MAGNITUD_ML,start = c(2011,2), end = c(2018,12), frequency = 12)
#head(indice.ts,10)
indice.ts
```
...
```{r}
hist(indice.ts,main="",ylab="valor", col='orange', xlab ="FECHA_UNIX")
title(main="SISMOS")
```
...
```{r}
plot(indice.ts,main="",ylab="valor", col='orange', xlab ="FECHA_UNIX")
title(main="SISMOS")
```
