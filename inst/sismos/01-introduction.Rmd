...
```{r}
sismo <- read_csv("/Users/wladimiravila/Desktop/Series_de_tiempo_MGM/data_sismo.csv")
...
sismo_3$fecha_hora <- paste(sismo_3$FECHA," ",sismo_3$HORA_UTC)
sismo_3 <- sismo_3[order(sismo_3$FECHA), ] #ordenamo sismo_3 de menor a mayor fecha
head(sismo_3,2)
```
